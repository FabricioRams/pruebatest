    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="menu-grid">
                ...
                <div class="menu-card">
                    <div class="icon">📦</div>
                    <h3>Catálogo de Productos <span class="badge">Próximamente</span></h3>
                    <p>Ver y gestionar productos disponibles</p>
                    <a href="#" class="btn">Próximamente</a>
                </div>
                
                <!-- CARRITO DE COMPRAS - Vendedor -->
                <% if (idCargo == 3) { %>
                    <div class="menu-card">
                        <div class="icon">🛒</div>
                        <h3>Carrito de Compras <span class="badge">Próximamente</span></h3>
                        <p>Gestionar ventas y carritos de compra</p>
                        <a href="#" class="btn">Próximamente</a>
                    </div>
                <% } else { %>
                    <div class="menu-card disabled">
                        <div class="icon">🛒</div>
                        <h3>Carrito de Compras <span class="badge restricted">Vendedor</span></h3>
                        <p>Módulo exclusivo para vendedores</p>
                        <a href="#" class="btn">Acceso Denegado</a>
                    </div>
                <% } %>
